...
class MyConfigureBudgetsComponent extends Component {
    ...
    async componentDidMount() {
        ...
        const response = await axios.get("http://localhost:3001/app/userConfigureBudgets", {
            headers: {
        ...
        if (editedCategory.length == 0 || editedItemName.length == 0 || editedBudgetValue == null) {
            ...
            try {
                ...
                const response = await axios.put(
                    "http://localhost:3001/app/userConfigureBudgets",
                    {
    ...
    handleDeleteConfirmation = async () => {
        ...
        try {
            await axios.delete('http://localhost:3001/app/userBudget/',
